...
This project contains python scripts for simulating the dynamics and for data analysis. Moreover, two Mathematica notebooks are provided to compute analytical solutions of the mean-field equations. Example data can be found in the respective folder.
